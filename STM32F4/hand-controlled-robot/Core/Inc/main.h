...
/* Private defines -----------------------------------------------------------*/
#define RIGHT_FWD_Pin GPIO_PIN_8
#define RIGHT_FWD_GPIO_Port GPIOE
#define RIGHT_REV_Pin GPIO_PIN_10
#define RIGHT_REV_GPIO_Port GPIOE
#define LEFT_FWD_Pin GPIO_PIN_12
#define LEFT_FWD_GPIO_Port GPIOE
#define LEFT_REV_Pin GPIO_PIN_13
